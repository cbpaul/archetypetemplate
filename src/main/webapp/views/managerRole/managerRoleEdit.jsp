	...
	<div class="span12">
		...
		<div class="portlet box grey">
			<div class="portlet-title">
				<div class="caption">
					<i class="icon-pencil"></i>${bean.id == null ?"新建角色":"修改角色"}
				</div>
				<div class="actions">
			...
			<div class="portlet-body form">
				...
				<form action="#" id="form-save" class="form-horizontal required-validate">
					...
					<div class="control-group">
						...
						<div class="controls">
							<input name="roleName" type="text" data-required="1" value="${bean.roleName }"
					...
					<div class="control-group">
						...
						<div class="controls">
							<textarea name="description" rows="3" maxlength="100"
								class="large m-wrap">${bean.description}</textarea>
						</div>
					</div>
